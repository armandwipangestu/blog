...
!(function (e, o) {
    ...
    function t(e) {
        var o,
            m = { templateSelector: "#CodeBadgeTemplate", contentSelector: "body", loadDelay: 0, copyIconClass: "fa fa-copy", copyIconContent: "", checkIconClass: "fa fa-check text-success", checkIconContent: "", onBeforeCodeCopied: null };
        function t() {
        ...
        function n() {
            ...
            for (var n = document.querySelector(m.templateSelector).innerHTML, c = document.querySelectorAll("pre>code.hljs"), a = 0; a < c.length; a++) {
                ...
                if (!r.querySelector(".code-badge")) {
                    ...
                    "ps" == (d = d ? d.toLowerCase() : "text") ? (d = "powershell") : "cs" == d ? (d = "csharp") : "js" == d ? (d = "javascript") : "ts" == d ? (d = "typescript") : "fox" == d ? (d = "foxpro") : "txt" == d && (d = "text");
    ...
    "boolean" != typeof o && (o = !1), (y.highlightJsBadge = t), y.module && y.module.exports && (y.module.exports.highlightJsBadge = t), o && t();
});
