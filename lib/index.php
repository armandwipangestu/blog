        ...
        <form action="" class="mt-4" method="POST" enctype="multipart/form-data">
          <?php if (isset($preview)) : ?>
            <div class="judul mb-4">
              ...
              <textarea type="text" class="form-control bg-dark text-muted" name="judul"><?= $preview['judul']; ?></textarea>
            ...
            <div class="tag mb-4">
              ...
              <textarea type="text" class="form-control bg-dark text-muted" name="tags"><?= $preview['tags']; ?></textarea>
            ...
            <div class="konten mb-4">
              ...
              <textarea class="form-control bg-dark text-muted" rows="3" placeholder="Something Text here . . ." name="konten"><?= $preview['konten']; ?></textarea>
            ...
            <div class="gambar mb-4">
              ...
              <input class="form-control bg-dark" type="file" name="gambar" style="border: none;">
            </div>
            <div class="button text-end">
              <button type="submit" class="btn btn-light" name="tombol"><i class="fas fa-eye"></i> Preview</button>
              <button type="submit" class="btn btn-light" name="upload"><i class="fas fa-upload"></i> Upload</button>
            </div>
          <?php endif; ?>
          <?php if (!isset($preview)) : ?>
            <div class="judul mb-4">
              <label class="form-label"><i class="fas fa-calendar-plus"></i> Judul</label>
              <textarea type="text" class="form-control bg-dark text-muted" name="judul"></textarea>
              <div class="form-text fst-italic">* Digunakan untuk judul pada postingan</div>
            </div>
            <div class="tag mb-4">
              <label class="form-label"><i class="fas fa-tags"></i> Tags</label>
